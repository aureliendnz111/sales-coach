  ...
  return (
    <div className="flex flex-col items-center justify-center h-full min-h-[70vh] text-center px-8">
      <div className="w-14 h-14 bg-stone-100 rounded-2xl flex items-center justify-center mb-5">
        <Swords className="w-7 h-7 text-stone-400" />
      </div>
      <h1 className="text-xl font-semibold text-stone-900 mb-2">Playground</h1>
      <p className="text-stone-400 text-sm max-w-xs leading-relaxed">
        Entraîne-toi au closing avec une IA qui joue le rôle du prospect. Obtiens un score et des recommandations pour progresser.
      </p>
