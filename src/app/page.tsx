  ...
  fr: {
    ...
    features: {
      ...
      items: [
        {
          icon: FileText,
          title: "Construisez votre script une bonne fois pour toutes",
          description: "Partez de zéro ou d'un template. Structurez vos étapes, vos questions clés, vos réponses aux objections. Votre process, formalisé.",
          tag: "Disponible",
          tagColor: "bg-emerald-50 text-emerald-700",
        },
        {
          icon: PhoneCall,
          title: "Un vrai diagnostic après chaque call",
          description: "Collez le transcript. Recevez un score sur 100, vos points forts, ce qui a bloqué et trois actions concrètes pour le prochain appel.",
          tag: "Disponible",
          tagColor: "bg-emerald-50 text-emerald-700",
        },
        {
          icon: Zap,
          title: "Un copilote pendant l'appel",
          description: "Suggestions en temps réel basées sur votre script. Sachez toujours où vous en êtes et quoi dire face à chaque objection.",
          tag: "Bientôt",
          tagColor: "bg-stone-100 text-stone-500",
        },
        {
          icon: Swords,
          title: "Entraînez-vous avant de jouer",
          description: "Simulez un appel complet face à une IA qui joue le prospect. Rodez votre pitch, testez vos réponses, sans aucun enjeu.",
          tag: "Bientôt",
          tagColor: "bg-stone-100 text-stone-500",
        },
      ],
      ...
      items: [
        {
          ...
          description: "Décrivez votre offre ou partez d'un template. Rumios structure vos étapes, vos questions et vos réponses aux objections courantes.",
        },
        {
          number: "02",
          title: "Collez le transcript de votre call",
          description: "Enregistrez avec tl;dv, Fathom ou Otter.ai, puis collez le texte dans Rumios. L'analyse démarre en quelques secondes.",
        },
        {
          number: "03",
          title: "Lisez le feedback, corrigez, progressez",
          description: "Score détaillé, erreurs identifiées, recommandations concrètes. Suivez votre progression call après call.",
        },
      ],
    },
    profiles: {
      ...
      items: [
        {
          emoji: "🎯",
          title: "Closers indépendants",
          desc: "Chaque deal compte. Analysez chaque call pour ne plus laisser de vente sur la table par manque de feedback.",
        },
        {
          emoji: "🧑‍💼",
          title: "Coachs",
          desc: "Vous vendez votre accompagnement en appel. Structurez votre closing, mesurez ce qui bloque, progressez à chaque conversation.",
        },
        {
          emoji: "🚀",
          title: "Entrepreneurs et freelances",
          desc: "La vente n'est pas votre métier, mais elle conditionne votre croissance. Rumios vous donne les outils pour la maîtriser.",
        },
      ],
    },
    cta: {
  ...
  en: {
    ...
    features: {
      ...
      items: [
        {
          icon: FileText,
          title: "Build your script once and for all",
          description: "Start from scratch or a template. Structure your stages, key questions, and objection responses. Your process, formalized.",
          tag: "Available",
          tagColor: "bg-emerald-50 text-emerald-700",
        },
        {
          icon: PhoneCall,
          title: "A real diagnosis after every call",
          description: "Paste the transcript. Get a score out of 100, your strengths, what blocked the deal, and three concrete actions for the next call.",
          tag: "Available",
          tagColor: "bg-emerald-50 text-emerald-700",
        },
        {
          icon: Zap,
          title: "A copilot during the call",
          description: "Real-time suggestions based on your script. Always know where you are and what to say when an objection comes up.",
          tag: "Coming soon",
          tagColor: "bg-stone-100 text-stone-500",
        },
        {
          icon: Swords,
          title: "Train before you play",
          description: "Simulate a full sales call against an AI playing the prospect. Test your responses, sharpen your pitch, with nothing at stake.",
          tag: "Coming soon",
          tagColor: "bg-stone-100 text-stone-500",
        },
      ],
      ...
      items: [
        {
          ...
          description: "Describe your offer or start from a template. Rumios structures your stages, questions, and answers to common objections.",
        },
        {
          number: "02",
          title: "Paste your call transcript",
          description: "Record with tl;dv, Fathom, or Otter.ai, then paste the text into Rumios. Analysis starts in seconds.",
        },
        {
          number: "03",
          title: "Read the feedback. Fix it. Repeat.",
          description: "Detailed score, identified mistakes, concrete recommendations. Track your progress call after call.",
        },
      ],
    },
    profiles: {
      ...
      items: [
        {
          emoji: "🎯",
          title: "Independent closers",
          desc: "Every deal matters. Analyze every call so you stop leaving sales on the table from lack of feedback.",
        },
        {
          emoji: "🧑‍💼",
          title: "Coaches",
          desc: "You sell your coaching over the phone. Structure your closing, measure what blocks, and improve with every conversation.",
        },
        {
          emoji: "🚀",
          title: "Entrepreneurs and freelancers",
          desc: "Sales isn't your job, but it drives your growth. Rumios gives you the tools to get good at it.",
        },
      ],
    },
    cta: {
    ...
    <div className="bg-white text-stone-900 min-h-screen">
            ...
            <div className="px-5 py-3 space-y-2">
              {c.mockCard.insights.map((ins, i) => (
                <div key={i} className="flex items-start gap-2">
                  <span className={cn(
                    "mt-0.5 w-4 h-4 rounded-full text-white text-[9px] font-bold flex items-center justify-center shrink-0",
      ...
      <section className="py-20 px-6 bg-stone-50 border-y border-stone-100">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-[15px] text-stone-500 leading-relaxed max-w-xl mx-auto mb-10">
            {c.problem.sub}
          </p>
              ...
              <div key={f.title} className="bg-white border border-stone-200 rounded-2xl p-6 flex flex-col gap-4 hover:border-stone-300 hover:shadow-sm transition-all">
                <div className="flex items-start justify-between">
                  <div className="w-9 h-9 bg-stone-100 rounded-lg flex items-center justify-center">
                    <f.icon className="w-4.5 h-4.5 text-stone-600" />
                  </div>
      ...
      <section className="py-20 px-6 bg-stone-900 text-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-3">
            ...
            <p className="text-[15px] text-stone-400 max-w-lg mx-auto mb-10">{c.metrics.sub}</p>
          </div>
      ...
      <section className="py-28 px-6">
        <div className="max-w-xl mx-auto text-center">
          <h2 className="text-[40px] font-bold tracking-tight leading-tight mb-4">
            {c.cta.headline}
          </h2>
          <p className="text-[15px] text-stone-500 leading-relaxed mb-7">
            {c.cta.sub}
          </p>
          <SignUpButton mode="modal">
